...
public class MainMenuResponderHelper extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("useDB : "+ useDB  + "<br />");
		
		String pageToNavigate = "";
		if(choice.equals("1")){
			pageToNavigate = "<a href=\"ListCities.html\">List All cities</a>";
		}
		else if(choice.equals("3")){
			pageToNavigate = "<a href=\"DeleteCity.html\">Delete A city</a>";
		}
		else if(choice.equals("2")){
			pageToNavigate = "<a href=\"AddCity.html\">Add a city</a>";
		}
		
		out.println(pageToNavigate);
		
		//boolean optEmail = (sendEmail == null?false:sendEmail.equals("1"));
		//boolean optDB = (useDB == null?false:useDB.equals("1"));
		
		boolean optEmail = (sendEmail == null?false:true);
